...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#160029] to-[#6e1bb3]">
      <Header />
     <div className="relative z-0 min-h-screen flex flex-col bg-gradient-to-br from-[#160029] to-[#6e1bb3] overflow-hidden">
    <AnimatedBackground />
          ...
          <div className="w-full max-w-6xl rounded-3xl p-10 md:p-16 relative overflow-hidden bg-gradient-to-br from-[#422d6a] via-[#6333b8] to-[#a974ee] shadow-2xl border border-[#b44cff]/50">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <p className="text-lg md:text-2xl text-white/90 mb-4">
                Veltrix предоставляет доступ к аналитическим материалам и инструментам, основанным на обработке открытых данных о спортивных событиях — быстро, удобно и без лишних сложностей.
              </p>
              <a
