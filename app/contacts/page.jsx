...
export default function ContactsPage() {
  return (
      ...
      <main className="flex flex-col items-center justify-center gap-10 px-6 py-16">
        <h1 className="text-4xl font-bold">Контакты</h1>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
          <div className="bg-[#3c0c64] rounded-xl p-6 shadow-md">
            <h2 className="text-xl font-bold mb-2">support@veltrix-bot.ru</h2>
            <p className="text-sm text-gray-300 mb-4">Для вопросов и поддержки</p>
            <a href="mailto:support@veltrix-bot.ru" className="inline-block text-white font-semibold hover:text-[#b44cff] transition">
              Написать →
            </a>
          </div>

          <div className="bg-[#3c0c64] rounded-xl p-6 shadow-md">
            <h2 className="text-xl font-bold mb-2">@Veltrix_ai</h2>
          ...
          <div className="bg-[#3c0c64] rounded-xl p-6 shadow-md">
            <h2 className="text-xl font-bold mb-2">@BetLyticBot</h2>
